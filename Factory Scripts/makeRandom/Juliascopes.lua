...
local requiredVariations = { "splits", "juliascope", "linear", "csch"  }
...
table.insert(xform.variations, { name="juliascope", weight = randInRange(-2., 2.),
                                 juliascope_power = math.random(1, 2), juliascope_dist = randInRange(-2., 2.) })
